//! HDL Content
//!
//! Base classes for HDL content management.
//! This module ports functionality from Java com.cburch.logisim.std.hdl.HdlContent.

use crate::hdl::model::{HdlModel, HdlModelListener, PortDescription};
